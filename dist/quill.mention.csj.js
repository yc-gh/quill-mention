...
var Mention = /*#__PURE__*/function () {
  function Mention(quill, options) {
    ...
    this.options = {
      ...
      //Prevent mention menu overflowing quill right edge
      fixMentionsBottomDirectionGrowth: false,
      //Fix mention menu growth direction downwards
  ...
  _createClass(Mention, [{
    ...
    value: function containerBottomIsNotVisible(topPos, containerPos) {
      ...
      if (this.options.mentionsContainment === "quill") {
        ...
        return topPos + mentionOffsetHeight > containerPos.height + quillScrollTop && topPos - quillScrollTop > mentionOffsetHeight;
      }
    ...
    value: function containerRightIsNotVisible(leftPos, containerPos) {
      ...
      if (this.options.mentionsContainment === "quill") {
        var mentionOffsetWidth = this.mentionContainer.offsetWidth;
        var quillScrollLeft = this.quill.container.scrollLeft;
        return leftPos + mentionOffsetWidth > containerPos.width + quillScrollLeft && leftPos - quillScrollLeft > mentionOffsetWidth;
      }
